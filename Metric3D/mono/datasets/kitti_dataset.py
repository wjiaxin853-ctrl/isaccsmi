...
class KITTIDataset(BaseDataset):
    ...
    def get_data_for_trainval(self, idx: int):
        ...
        # print('curr_rgb shape:', curr_rgb.shape, 'curr_depth shape:', curr_depth.shape, 'curr_normal shape:', curr_normal.shape, 'curr_sem shape:', curr_sem.shape)
        
        th = 712 # target size for bottom cropping, a common practice for kitti training
        tw = 1216
        ...
        # print('curr_rgb shape:', curr_rgb.shape, 'curr_depth shape:', curr_depth.shape)
    ...
    def process_depth(self, depth, rgb):
        ...
        H, W = depth.shape
        crop_h_up = int(0.01 * H)
        crop_h_down = int(1 * H)
        crop_w_left = int(0.01 * W)
        crop_w_right = int(1 * W)
